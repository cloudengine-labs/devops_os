# Legacy Repo-Local Development Container

This directory contains the archived repo-local devcontainer implementation that previously lived under `.devcontainer/`.
It is kept for historical reference and is no longer the active generation path.
